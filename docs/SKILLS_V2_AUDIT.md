...
| **Total** | **31** | README inventory matches this PR; investor-method profiles live in a separate repository |
...
- Investor-method profiles are not part of this repository. See `AlphaGBM/investment-masters` for the separate, reference-only catalogue.
