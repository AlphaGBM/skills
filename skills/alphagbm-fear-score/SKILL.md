...
description: "Fear Score reference method. Use when studying this focused method, not to run an API request. External API-key access for its legacy endpoints is not published in this release."
---
